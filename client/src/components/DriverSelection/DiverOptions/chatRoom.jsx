      ...
      <div className='bigDiv'>
        ...
        {currentUser.usertype === 'driver' && messages.length === 1 ?
          <span className='reject-button'>
            <Button className='reject-button' varient='primary' onClick={() => { handleAccept(Number(currentUser.userId) === Number(messages[0].message_sender) ? Number(currentUser.userId) : messages[0].message_sender) }}>Accept Rider</Button>
            <Button className='reject-button' varient='secondary' onClick={() => { handleReject(Number(currentUser.userId) === Number(messages[0].message_sender) ? Number(currentUser.userId) : messages[0].message_sender) }}>Reject Rider</Button>
